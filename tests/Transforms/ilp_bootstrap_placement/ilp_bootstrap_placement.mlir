// RUN: heir-opt --secret-insert-mgmt-ckks=level-budget=3 --ilp-bootstrap-placement %s | FileCheck %s

// Test ILP bootstrap placement with a computation that requires multiple
// bootstrap operations to stay within level budget of 3.
//
// Computation:
// L1 = I1 * I2   (level 2)
// L2 = I2 * I3   (level 2)
